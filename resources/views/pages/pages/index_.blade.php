                        ...
                        @slot('body')
                            @foreach($data as $key=>$value)
                                <tr>
                                    ...
                                    <td>{{$value->name}} {!! $value->user_id === \Illuminate\Support\Facades\Auth::id() ? '<span class="badge badge-pill badge-primary">Cá nhân</span>' : '<span class="badge badge-pill badge-success">' . $value->user->email . '</span>' !!}</td>
