                        ...
                        @slot('body')
                            @foreach($data as $key=>$value)
                                <tr>
                                    ...
                                    <td>{{$value->page->name}} {!! $value->user_parent === \Illuminate\Support\Facades\Auth::id() ? '<span class="new badge blue" data-badge-caption="Cá nhân"></span>' : '<span class="new badge" data-badge-caption="' . $value->userParent->email . '"></span>' !!}</td>
                                    ...
                                    <td><span title="Go to page"><a target="_blank"
                                        ...
                                        @endif
                                        <span title="Delete page"><a data-id="{{ $value->_id }}"
